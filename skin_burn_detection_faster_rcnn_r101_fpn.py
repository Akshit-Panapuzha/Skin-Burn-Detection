# -*- coding: utf-8 -*-
"""Skin burn detection - Faster RCNN R101 FPN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UFgy1U7zf2uY5KpFf6lsx2XTTThdEz7T
"""
...
!curl -L "https://app.roboflow.com/ds/qbY6nwwNLC?key=gJz0e3rc6E" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
...
cfg.SOLVER.BASE_LR = 0.00125         # Base learning rate: 1e-3   
...
evaluator_val = COCOEvaluator("my_dataset_val", cfg, False, output_dir="./output/")
valid_loader = build_detection_test_loader(cfg, "my_dataset_val")
inference_on_dataset(trainer.model, valid_loader, evaluator_val)
